CREATE TABLE [dbo].[tBookTransaction] (
	...
	[idBookingRecord]	bigint	NOT NULL,
	[idAccount]		bigint	NOT NULL,
	[idAccountCounter]	bigint	NOT NULL,
...
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tBookTransaction] ADD CONSTRAINT [FK_tBookTransaction_idAccount]
...
GO
CREATE NONCLUSTERED INDEX [IX_tBookTransaction_idAccount] ON [dbo].[tBookTransaction]
(
	[idAccount] ASC
) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
