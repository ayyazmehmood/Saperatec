CREATE TABLE [dbo].[tPlanAccountFunction] (
	...
	[idPlanFunctionDef]	bigint	NOT NULL,
...
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tPlanAccountFunction] ADD CONSTRAINT [FK_tPlanAccountFunction_idAccount]
...
GO
CREATE NONCLUSTERED INDEX [IX_tPlanAccountFunction_idAccount] ON [dbo].[tPlanAccountFunction]
(
	[idAccount] ASC
) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
